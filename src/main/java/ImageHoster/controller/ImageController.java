...
public class ImageController {
    ...
    public String showImage(@PathVariable("imageId") Integer id, @PathVariable("title") String title, Model model) {
        ...
        model.addAttribute("comments",image.getComments()); //attribute comments added into model objects
        return "images/image";
    }
    ...
    public String editImageSubmit(@RequestParam("file") MultipartFile file, @RequestParam("imageId") Integer imageId, @RequestParam("tags") String tags, Image updatedImage, Model model, HttpSession session) throws IOException {
       ...
       if(image.getUser().equals(loggeduser)) //Override the equals() method in the user model
        {
    ...
    public String deleteImageSubmit(@RequestParam(name="imageId") Integer imageId, Model model, HttpSession session) {
        ...
        if(image.getUser().equals(loguser))  //Override equals() method in user model
        {
