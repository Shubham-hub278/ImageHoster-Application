...
public class UserProfile {
    ...
    public boolean equals(Object o) {
        ...
        return getId().equals(that.getId()) &&
                ...
                getEmailAddress().equals(that.getEmailAddress()) &&
                getMobileNumber().equals(that.getMobileNumber());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getId(), getFullName(), getEmailAddress(), getMobileNumber());
    }
}
